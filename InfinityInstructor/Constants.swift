...
struct Constants {
    ...
    static let unit1 = Unit(id: 0, name: "Quadratics", description: "", tests: [Test(id: 0, name: "Quadratics Unit Test", description: "", value: 1, date: Date(timeIntervalSinceNow: -20), sets: [set1, set2, set3, diverseSet])], sets: [set1,set2,set3, diverseSet])
    ...
    static let studyClass1 = Class(id: 0, name: "Algebra 2", description: "Sandwich", units: [unit1])
