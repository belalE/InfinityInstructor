...
struct TestList_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return TestList(tests: [Test(id: 0, name: "Quadratics Unit Test", description: "", value: 1, sets: [set1], date: Date(timeIntervalSinceNow: 200)),Test(id: 1, name: "Semester Exam", description: "", value: 3, sets: [set1,set2,set3], date: Date(timeIntervalSinceNow: 200000))])
    }
}
